...
The examples in `eric-slider-animate.php` use class names designed to pair with [Display Posts Shortcode](https://displayposts.com/) by Bill Erickson, but that is entirely optional and independent of the slider itself.
