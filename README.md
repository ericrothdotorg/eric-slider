...
Visual styles (colours, border-radius, spacing) are intentionally kept out of the main CSS so you can theme the slider via your own stylesheet or CSS variables.
